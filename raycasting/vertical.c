...
/*   Updated: 2023/12/16 19:00:36 by omakran          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_the_vertical(t_game *game, float ray_angle)
{
	while (1)
	{
		if ((game->player_pos->is_facing_left && check_if_hit_wall(game, game->ver->x_ver - SQUAR_SIZE, game->ver->y_ver))
			|| (!game->player_pos->is_facing_left && check_if_hit_wall(game, game->ver->x_ver, game->ver->y_ver)))
			break ;
