...
/*   Updated: 2023/12/17 18:05:39 by yoamzil          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (is_surrounded_by_walls(game->file, i)
		&& is_valid_map_chars(game->file, i) && has_valid_pec(game, i) && has_right_identifiers(*game, game->file))
		return (1);
	return (0);
}
